...
let g:colors_name="primerdark"

" Set to "256" for 256-color terminals, or
" set to "16" to use your terminal emulator's native colors
" (a 16-color palette for this color scheme is available; see
" < https://github.com/joshdick/primerdark.vim/blob/master/README.md >
" for more information.)
if !exists("g:primerdark_termcolors")
  let g:primerdark_termcolors = 256
endif

" Not all terminals support italics properly. If yours does, opt-in.
if !exists("g:primerdark_terminal_italics")
  let g:primerdark_terminal_italics = 0
endif

" This function is based on one from FlatColor: https://github.com/MaxSt/FlatColor/
" Which in turn was based on one found in hemisu: https://github.com/noahfrederick/vim-hemisu/
let s:group_colors = {} " Cache of default highlight group settings, for later reference via `primerdark#extend_highlight`
function! s:h(group, style, ...)
  if (a:0 > 0) " Will be true if we got here from primerdark#extend_highlight
  ...
  if g:primerdark_terminal_italics == 0
...
function! primerdark#set_highlight(group, style)
  call s:h(a:group, a:style)
endfunction

function! primerdark#extend_highlight(group, style)
...
let s:colors = primerdark#GetColors()
...
call s:h("Number", { "fg": s:cyan }) " a number constant: 234, 0xff
...
call s:h("PreProc", { "fg": s:red }) " generic Preprocessor
call s:h("Include", { "fg": s:red }) " preprocessor #include
call s:h("Define", { "fg": s:red }) " preprocessor #define
call s:h("Macro", { "fg": s:red }) " same as Define
call s:h("PreCondit", { "fg": s:yellow }) " preprocessor #if, #else, #endif, etc.
call s:h("Type", { "fg": s:red }) " int, long, char, etc.
call s:h("StorageClass", { "fg": s:red }) " static, register, volatile, etc.
...
if get(g:, 'primerdark_hide_endofbuffer', 0)
