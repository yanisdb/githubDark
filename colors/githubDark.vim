...
let g:colors_name="githubDark"

" Set to "256" for 256-color terminals, or
" set to "16" to use your terminal emulator's native colors
" (a 16-color palette for this color scheme is available; see
" < https://github.com/joshdick/githubDark.vim/blob/master/README.md >
" for more information.)
if !exists("g:githubDark_termcolors")
  let g:githubDark_termcolors = 256
endif

" Not all terminals support italics properly. If yours does, opt-in.
if !exists("g:githubDark_terminal_italics")
  let g:githubDark_terminal_italics = 0
endif

" This function is based on one from FlatColor: https://github.com/MaxSt/FlatColor/
" Which in turn was based on one found in hemisu: https://github.com/noahfrederick/vim-hemisu/
let s:group_colors = {} " Cache of default highlight group settings, for later reference via `githubDark#extend_highlight`
function! s:h(group, style, ...)
  if (a:0 > 0) " Will be true if we got here from githubDark#extend_highlight
  ...
  if g:githubDark_terminal_italics == 0
...
function! githubDark#set_highlight(group, style)
  call s:h(a:group, a:style)
endfunction

function! githubDark#extend_highlight(group, style)
...
let s:colors = githubDark#GetColors()
...
if get(g:, 'githubDark_hide_endofbuffer', 0)
